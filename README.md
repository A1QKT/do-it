...
| `GET` | `/v1/media-seed/latest` | **`routes`** + **`routes_map`**: route **name** → **score** (1 best … 100 worst) and **reason** (model text). Query **`full=true`** for raw export blob. Env **`MEDIA_SEED_EXPORT_PATH`**. |
